...
#define KVM_MAX_CREATED_IO_MEMS 512
...
enum pkvm_iommu_driver_id {
	...
	PKVM_IOMMU_DRIVER_ROCKCHIP_IOMMU,
...
int pkvm_iommu_rockchip_iommu_register(struct device *dev, phys_addr_t pa, struct hyp_rk_iommu_info *info);
