...
enum __kvm_host_smccc_func {
	...
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_alloc_domain,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_free_domain,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_attach_dev,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_detach_dev,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_map,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_unmap,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_iova_to_phys,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_flush_iotlb_all,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_rk_enable,
	__KVM_HOST_SMCCC_FUNC___pkvm_iommu_rk_disable,
...
#define per_cpu_ptr_nvhe_sym(sym, cpu)						\
	({									\
		...
		base = kvm_arm_hyp_percpu_base_el1[cpu];			\
...
extern unsigned long kvm_arm_hyp_percpu_base_el1[NR_CPUS];
...
extern unsigned int __kvm_get_el2_trap_count(void);
extern void __kvm_clear_el2_trap_count(void);
